...
class VolumeHistoryScreen extends StatefulWidget {
  final List<VolumeHistoryEntry> historyEntries;
  final Function(List<VolumeCalculatorEntry>) onLoadEntries;

  const VolumeHistoryScreen({
    super.key,
  ...
  @override
  State<VolumeHistoryScreen> createState() => _VolumeHistoryScreenState();
}

class _VolumeHistoryScreenState extends State<VolumeHistoryScreen> {
  late List<VolumeHistoryEntry> _historyEntries;
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                '${localizations.translate('total_volume')}: ${entry.totalVolume.toStringAsFixed(2)} m³',
                                style: TextStyle(
                                  fontSize: AppFonts.bodySmall,
                                ),
                              ),
